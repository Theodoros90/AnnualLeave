...
export type AdminSection = 'dashboard' | 'organization' | 'reminders-notifications' | 'maintenance' | 'system-log' | 'leave' | 'leave-types' | 'users' | 'departments' | 'projects' | 'project-activities' | 'components' | 'project-types'
